...
execute if score coreDebug mcm matches 1 run tellraw @a ["",{"text":"CMD: ","bold":true,"color":"gold"},{"nbt":"a[0]","storage":"cmd","bold":true,"color":"green"}," ",{"nbt":"a[1]","storage":"cmd","bold":true,"color":"green"}," ",{"nbt":"a[2]","storage":"cmd","bold":true,"color":"green"}," ",{"nbt":"a[3]","storage":"cmd","bold":true,"color":"green"}," ",{"nbt":"a[4]","storage":"cmd","bold":true,"color":"green"}," ",{"nbt":"a[5]","storage":"cmd","bold":true,"color":"green"}," ",{"nbt":"a[6]","storage":"cmd","bold":true,"color":"green"}]
...
execute unless score coreStop mcm matches 1 if score sessionStop mcm matches 0 run function core:command
